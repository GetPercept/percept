...
- **Action dispatcher** — 7 action types: email, text, reminder, search, calendar, note, order. Contact resolution, spoken email normalization ("david at vectorcare dot com" → user@example.com)
